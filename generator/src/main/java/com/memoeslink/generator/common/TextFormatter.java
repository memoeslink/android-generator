...
public class TextFormatter {
    ...
    private static final String FORMAT_REGEX = "^(" + HTML_TAG_REGEX + ",)*" + HTML_TAG_REGEX + "$";
    ...
    public static String formatText(String text, String format) {
        ...
        if (StringHelper.isNotNullOrBlank(text) && matcher.find()) {
            ...
            if (parts.contains("li"))
                sb.insert(0, "<li>").append("</li>");
            ...
            if (parts.contains("strike"))
                sb.insert(0, "<strike>").append("</strike>");

            if (parts.contains("sub"))
                sb.insert(0, "<sub>").append("</sub>");

            if (parts.contains("sup"))
                sb.insert(0, "<sup>").append("</sup>");
